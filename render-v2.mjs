...
const framesDir = '/tmp/remotion-frames-v2';
const FPS = 30;
...
console.log('🎬 Raúl Butaci UTMB V2 Video Renderer');
console.log('=====================================');
...
async function main() {
	try {
		...
		console.log('⏱️  Duration: ' + DURATION_SECONDS + ' seconds (87s)');
		console.log('📹 Resolution: ' + WIDTH + 'x' + HEIGHT + ' (9:16 vertical)');
		console.log('🎬 Frames: ' + DURATION_FRAMES + ' @ ' + FPS + ' fps');
		console.log('🎵 Audio: raul-butaci-audio-body.ogg (75 seconds)');
		console.log('========================================\n');
		process.exit(0);
	} catch (error) {
		console.error('\n❌ Error:', error.message);
