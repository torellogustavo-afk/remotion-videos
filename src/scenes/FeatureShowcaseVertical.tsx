...
const FeatureCardVertical: React.FC<{
  ...
  delay: number;
  frameProgress: number;
}> = ({ icon, title, description, delay, frameProgress }) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 18, fontWeight: 700, color: '#00b8ff', marginBottom: 10, fontFamily: "'Inter', sans-serif" }}>
        {title}
      </div>
...
export const FeatureShowcaseVertical: React.FC<FeatureShowcaseVerticalProps> = ({ frameProgress }) => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ fontSize: 36, fontWeight: 900, color: 'white', margin: 0, fontFamily: "'Inter', sans-serif", marginBottom: 8 }}>
          Herramientas
        </h2>
